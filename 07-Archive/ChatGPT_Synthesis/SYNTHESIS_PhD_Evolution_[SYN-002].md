...
uid: SYN-002
type: synthesis
title: "Synthesis: PhD Methodology Evolution — From Idea to Protocol"
date: 2026-02-28
...
# Synthesis: PhD Methodology Evolution — From Idea to Protocol

> **Time span:** April 2023 - February 2026  
> **Extracted insights:** 72 zettels  
> **Current status:** Protocol finalized, ethics approved

---

## The Journey

### 1. Genesis (April 2023)
**First query:** "What would be the best PhD titles?"

**State of mind:**
- Broad interest in metabolomics
- Clinical data available
- Unclear specific direction

**Key insight:** Clinical application of metabolomics has potential

---

### 2. Focus (September 2023)
**Query:** "PhD in insulin resistance with diet intervention"

**Evolution:**
- General metabolomics → Specific condition (IR)
- Observation → Intervention
- Biomarkers identified (HOMA-IR, glucose, HbA1c)

**Methodology emerges:**
- Find metabolites
- Implement diet/supplements
- Reassess
...
### 3. Refinement (2024)
**Key developments:**
- Zettelkasten methodology adoption
- Statistical approaches explored
- Sample size calculations
- Ethical approval process

**Challenges faced:**
- Methodology mistakes identified and corrected
- Protocol iterations
- Literature gaps discovered

---

### 4. Maturity (2025-2026)
**Current state:**
- Protocol finalized
- Ethics approved
- Recruitment planned
- Adipic acid as key biomarker

**Partnership evolution:**
- From "help me write" to "co-design research"
- AI as methodological consultant
...
**2023:** "What should I study?"  
**2024:** "How should I design the study?"  
**2025:** "How do I optimize the protocol?"  
**2026:** "How do I execute at the highest level?"
...
| Aspect | 2023 | 2026 |
|--------|------|------|
| **Scope** | Broad metabolomics | Targeted IR biomarkers |
| **Method** | Unclear | Statistically rigorous |
| **AI Role** | Information source | Research partner |
| **Confidence** | Exploratory | Committed |
| **Biomarker** | General | Adipic acid specific |
...
This synthesis reveals how AI partnership enabled research development:

1. **Ideation** — Brainstorming titles, approaches
2. **Refinement** — Iterative protocol improvement
3. **Validation** — Checking methodology, identifying errors
4. **Execution support** — Ongoing consultation

**The PhD is co-designed.** Not just your work, but the product of 2+ years of human-AI dialogue.

---

*Synthesized February 28, 2026*  
*From 673 ChatGPT conversations, 30 RON cycles, and countless iterations*
