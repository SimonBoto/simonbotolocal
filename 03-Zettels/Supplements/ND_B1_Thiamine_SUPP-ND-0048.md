...
price_per_day: 0.20
target: nervous-system, energy-metabolism, heart-function
...
**Product Code:** —  
**Price:** €18.00 (90 vegetable capsules)  
**Daily Cost:** ~€0.20/day (1 capsule/day)

## Description
Vitamin B1 (thiamine) supplement contributing to normal nervous system function, normal heart function, and normal psychological function. Thiamine is a B-complex vitamin involved in metabolic processes aimed at energy production.

## Ingredients per Capsule (Daily Dose)

| Component | Amount | % NRV |
|-----------|--------|-------|
| Thiamine (Vitamin B1) | 100 mg | 9091% |

## Usage
Take 1 capsule daily with water or as directed by your physician.

## Key Features
- **High-dose B1** — 100 mg (9091% NRV)
- **Nervous system support** — essential for nerve function
- **Heart function** — cardiac muscle energy
- **Energy metabolism** — converts food to energy
- **Psychological function** — brain energy support
- **Excellent value** — €0.20/day

## Thiamine Functions

### Energy Metabolism
- **Carbohydrate metabolism** — converts glucose to energy
- **Pyruvate dehydrogenase** — critical enzyme cofactor
- **ATP production** — cellular energy currency
- **All cells use B1** — universal energy requirement

### Nervous System
- **Nerve conduction** — action potential propagation
- **Neurotransmitter synthesis** — acetylcholine production
- **Myelin maintenance** — nerve insulation
- **Brain energy** — high metabolic demand

### Cardiovascular
- **Heart muscle energy** — constant ATP need
- **Cardiac function** — normal contraction
- **Beriberi prevention** — thiamine deficiency disease

## Who Needs B1?
- **High carbohydrate diets** — increased requirement
- **Alcohol users** — reduced absorption, increased excretion
- **Diabetes** — higher thiamine needs
- **Bariatric surgery** — malabsorption risk
- **Elderly** — reduced intake and absorption
- **Pregnancy/lactation** — increased needs

## Clinical Notes
- **Very high dose** — 100 mg vs RDA 1.1-1.2 mg
- **Water-soluble** — excess excreted
- **No toxicity** — very safe even at high doses
- **Take with food** — reduces stomach upset
- **Alcohol depletes** — avoid concurrent use

## Deficiency Signs (Beriberi)
- **Wet beriberi** — heart failure, edema
- **Dry beriberi** — neuropathy, muscle wasting
- **Wernicke-Korsakoff** — brain damage (alcoholics)
- **Fatigue, irritability** — early symptoms
...
## Dosing Cost Table
| Capsules | Daily Cost | Thiamine | Use Case |
|----------|------------|----------|----------|
| 1 | €0.20 | 100 mg | Standard dose |

## Comparison with Be Well Multivitamin
| Feature | B1 Thiamine | Be Well |
|---------|-------------|---------|
| B1 dose | 100 mg | 25 mg |
...
*EOF notification: 26769/1-3-2024*
