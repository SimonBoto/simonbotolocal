...
- **Mechanism:** Low estrogen, poor nutrition, sarcopenia
...
| **Vitamin D level** | Not included — separate assessment |
...
## Related Zettels
- [[FRAX_Output_Thresholds_Treatment_Decisions_[Z-001-0110].md]] — Using the calculated score
- [[FRAX_Limitations_Clinical_Gaps_[Z-001-0111].md]] — What's missing
