...
- Body regulates conversion rate based on calcium status
- Wide therapeutic window
- Standard for high-dose protocols

**Calcitriol (requires caution):**
- Active hormone, no conversion needed
- Bypasses renal regulatory control
- Directly stimulates calcium absorption/bone resorption
- Risk of hypercalcemia even at lower doses
- **Reserved for:** hypoparathyroidism, CKD, specific medical conditions
