...
# Oxalic Acid Chemistry and Properties

## Basic Structure
- **Molecular formula:** C₂H₂O₄
- **Classification:** Simplest dicarboxylic acid
- **Functional groups:** Two carboxylic acid (-COOH) groups

## Physical Forms
| Form | Formula | Characteristics |
|------|---------|-----------------|
| **Anhydrous** | C₂H₂O₄ | Dry, water-free |
| **Dihydrate** | C₂H₂O₄·2H₂O | Contains two water molecules |

## Physical Properties
- **Appearance:** White crystalline solid
- **Solubility:** Highly soluble in water → colorless solution
- **Acidity:** Relatively strong organic acid (pKa₁ ≈ 1.25, pKa₂ ≈ 4.14)
...
| Dye mordant | Binds dyes to fabric via metal coordination |
...
- **Dietary:** [[Oxalic_Acid_Dietary_Sources_[Z-101-0466].md]]
