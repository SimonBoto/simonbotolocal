...
|------|---------|---------|
| **Predictive** | Identify at-risk individuals before disease | Pre-diabetes markers (elevated glucose) |
...
2. **Early diagnosis** — Before symptom appearance
...
Biomarkers can originate from **any omics level:**
...
```
Discovery (Non-targeted omics analysis)
    ↓
Comparison (Patients vs. healthy controls)
    ↓
Candidate identification (Differential molecules)
    ↓
Mechanistic understanding (Pathway analysis)
    ↓
Validation (Large population studies)
    ↓
...
| Biomarker Type | Application in METHAP |
|----------------|----------------------|
| **Predictive** | Baseline adipic acid predicts VD response? |
| **Prognostic** | Adipic acid trend predicts IR progression |
| **Pharmacodynamic** | Post-VD adipic acid changes indicate efficacy |

**Trial Design Elements:**
- Baseline metabolomic profiling
- Patient stratification by metabolic phenotype
...
- Thousands of molecules analyzed simultaneously
- Multiple omics layers to integrate
- Complex statistical analysis required
- **Challenge:** Translating data into clinical decisions

**Solution:** Multi-disciplinary collaboration
