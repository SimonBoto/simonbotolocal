...
**Enzymes** are the key functional proteins:
- Catalyze (accelerate) biochemical reactions
- Determine metabolic pathway flux
...
|------------|---------|-------------|
| **Crystallography** | 3D structure determination | Drug binding site identification |
...
- Specific proteins as therapeutic targets
...
|-------|------------------|------------------------|
| Proteomics | Protein abundance and activity | 1 step removed |
