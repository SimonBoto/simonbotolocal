...
uid: Z-002-0763
type: zettel
title: "Elimination Diets for Autoimmune Improvement — AIP Protocol"
aliases: ["Z-002-0763", "AIP-Autoimmune"]
domain: 002
status: conscious
tags: [zettel, elimination-diet, AIP, autoimmune, protocol, gluten-free]
...
| Step | Timeline |
|------|----------|
| **One food at a time** | Every 3-7 days |
| **Small amount first** | Test tolerance |
| **Monitor 72 hours** | Delayed reactions |
| **Keep a food diary** | Track symptoms |
...
| Disease | Outcome |
|---------|---------|
| **IBD (Crohn's, UC)** | Symptom remission, reduced meds |
| **Hashimoto's** | Reduced TPO antibodies |
| **Rheumatoid arthritis** | Reduced pain, inflammation |
...
| Disease | Benefit |
|---------|---------|
| **Celiac** | Essential (only treatment) |
| **Hashimoto's** | Reduced antibodies |
| **MS** | Reduced relapses |
| **T1D** | Better control |
...
| Mechanism | Effect |
|-----------|--------|
| **Removes triggers** | Stops immune activation |
| **Heals gut** | Reduces permeability |
| **Reduces inflammation** | Systemic benefit |
| **Nutrient density** | Supports healing |
...
|-----------------|----------------|
| **Active symptoms** | High motivation |
| **Failed medications** | Willing to change diet |
| **Early disease** | Better outcomes |
...
- **Reference:** AIP trials, clinical studies

---
*Z-002-0763 | Created: 2026-04-05 | Status: conscious*
