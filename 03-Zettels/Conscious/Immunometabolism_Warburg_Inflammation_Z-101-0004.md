...
| Phenotype | Metabolism | Cell Types | Function |
|-----------|------------|------------|----------|
| Pro-inflammatory | Aerobic glycolysis | M1 macrophages, activated T-cells, NK cells | Attack pathogens, inflammation |
| Anti-inflammatory | Oxidative phosphorylation | M2 macrophages, regulatory T-cells | Tissue repair, tolerance |

**Therapeutic targeting strategies:**
- **2-deoxyglucose (2-DG)** — Glycolysis inhibitor (blocks pro-inflammatory cells)
- **Glut-1 inhibitors** — Blocks glucose uptake in activated immune cells
- **GAPDH modulation** — Metabolic checkpoint regulation
...
**Metabolic reprogramming as therapy:** Inhibiting glycolysis in autoimmune disease reduces inflammatory cell function while sparing oxidative cells that promote resolution.

## Links

- **Upstream:** [[Z-001-0031]] — Inflammatory signaling mechanisms
- **Parallel:** [[Z-101-0002]] — Metformin modulates metabolism
- **Downstream:** [[Z-001-0038]] — Inflammation → IR vicious cycle

## Context

**Also relevant to:** [[MOC-Immunometabolism]], [[MOC-Warburg-Effect]]
