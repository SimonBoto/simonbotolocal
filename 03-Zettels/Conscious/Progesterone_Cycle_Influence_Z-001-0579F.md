...
- **Hypothalamic effects**: Increases GnRH pulse frequency in luteal phase
- **Pituitary effects**: Enhances LH response to GnRH
...
- Progesterone receptor isoforms (PRA and PRB) have different regulatory functions
- Progesterone feedback is mediated through GABAergic neurons in the hypothalamus
- Progesterone metabolites (allopregnanolone) have neuroactive effects on HPGA axis
