...
**IR Core Panel:**
- [[Z-001-0046]] — HOMA-IR (correlates r=0.6-0.7 with TG/HDL)
- [[Z-001-0048]] — TyG Index (similar lipid-glucose approach)
- [[Z-001-0047]] — HOMA-β (high TG/HDL + high HOMA-β = compensated IR)

**Lipid Patterns:**
- [[Z-006-0001]] — Lipid Pattern A/B (TG/HDL >3.0 strongly predicts Pattern B)
- [[Z-006-0002]] — ApoB (TG/HDL correlates with small dense LDL particle count)

**Mechanism:**
- [[Z-001-0018]] — Lipotoxicity (elevated TG = hepatic steatosis = IR marker)
