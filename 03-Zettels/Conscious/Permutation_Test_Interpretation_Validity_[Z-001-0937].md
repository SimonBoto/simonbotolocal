...
## Related Zettels
- [[OPLS_DA_Overfitting_Risks_Small_Samples_[Z-001-0935].md]] — Overfitting context
- [[Cross_Validation_Strategies_Omics_Models_[Z-001-0938].md]] — Next validation level
- [[Biomarker_Validation_Pipeline_Requirements_[Z-001-0560].md]] — Full pipeline
