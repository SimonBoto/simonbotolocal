...
- **Slow-wave sleep**: Critical for testosterone production in males
- **REM sleep**: Associated with LH pulses and gonadotropin secretion
...
- Testosterone production is directly coupled to slow-wave sleep architecture
- Melatonin has inhibitory effects on the HPGA axis, explaining seasonal breeding patterns
- Circadian clock genes (CLOCK, BMAL1) regulate GnRH neuronal activity