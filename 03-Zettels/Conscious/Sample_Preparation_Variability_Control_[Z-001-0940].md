...
# Sample Preparation Variability Control in Metabolomics
...
| **Time of day** | Cortisol, fatty acids circadian | Collect same time ±2 hours |
...
## Related Zettels
- [[Batch_Effects_Detection_Correction_Metabolomics_[Z-001-0939].md]] — Analytical variation
- [[Instrument_Drift_QC_Monitoring_Requirements_[Z-001-0941].md]] — Instrument variation
