...
uid: Z-002-0803
type: zettel
title: "Glucose vs Insulin: Different Vessel Types, Different Damage"
aliases: ["Z-002-0803", "Insulin-Large-Vessel-Damage"]
domain: 002
status: conscious
tags: [zettel, glucose, insulin, vessels, microvascular, macrovascular, complications]
...
## Glucose Toxicity: Small Vessels (Microvascular)
...
## Insulin Toxicity: Large Vessels (Macrovascular)
...
### For CVD Prevention
- **Insulin control is key** — not just glucose
- Low-carb diets, metformin, exercise, weight loss
- Target fasting insulin 2-10 μIU/mL
...
| **>15 μIU/mL** | Significant insulin resistance |

## Prevention Strategy
- Measure fasting insulin, not just glucose
- Target insulin sensitivity for CVD prevention
- Different strategies for micro vs macrovascular protection
