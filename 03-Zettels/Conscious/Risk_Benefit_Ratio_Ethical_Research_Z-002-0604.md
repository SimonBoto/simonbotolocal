...
|-----------|---------------|
| **Risk minimization** | Use least risky methods that achieve objectives |
| **Probability** | Likelihood of harms occurring |
| **Magnitude** | Severity of potential harms |
| **Duration** | How long harms may persist |
...
|-------|------------|----------|
| **Minimal** | ≤ daily life risks | Standard protections |
| **Minor** | Temporary discomfort | Enhanced monitoring |
...
- **Minimal risk:** Blood draw (temporary discomfort)
- **Minimal risk:** Urine collection (non-invasive)
