...
**Insulin Resistance:**
- [[Z-001-0046]] — HOMA-IR (hypothyroidism worsens IR via ↓GLUT4, ↓mitochondrial function)
- Hypothyroid → weight gain, dyslipidemia, glucose intolerance

**Vitamin D:**
- [[Z-002-0004]] — VitD optimal range (VDR and TR share nuclear receptor mechanisms)
- Both affect metabolic rate, immune function

**Methylation:**
- [[Z-004-0001]] — Homocysteine (thyroid affects methylation via B12/folate absorption)
