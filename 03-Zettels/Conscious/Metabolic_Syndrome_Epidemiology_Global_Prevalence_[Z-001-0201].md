...
# Metabolic Syndrome — Epidemiology and Global Prevalence
...
|--------|------------|-------|
| North America | 30-35% | Highest rates globally |
| Europe | 20-30% | Varies by country |
| South Asia | 20-30% | Higher at lower BMI ("thin-fat" phenotype) |
| East Asia | 15-25% | Rapidly increasing with urbanization |
| Latin America | 25-35% | High Hispanic prevalence |

### By Age and Sex
- **Age:** Prevalence increases with age; peaks 60-70 years
- **Sex differences:**
  - Men: Higher rates until age 50
  - Women: Higher rates post-menopause
  - Overall: Variable by population

### By Ethnicity
- **Higher risk:** South Asian, Hispanic, African American, Native American
- **Mechanism:** Genetic predisposition + environmental factors

## Risk Factors for Development

1. **Urbanization and Westernization**
2. **Sedentary lifestyle** (screen time, automation)
...
Understanding epidemiology informs:
- **Target population size** for recruitment
- **Stratification variables** (age, sex, ethnicity)
