...
LA (18:2 n-6) ──Δ6D──> GLA (18:3 n-6) ──E──> DGLA (20:3 n-6) ──Δ5D──> AA (20:4 n-6)
     (Linoleic)       (Gamma-linolenic)    (Dihomo-γ-linolenic)    (Arachidonic)
```

**AA produces:** Prostaglandins (series 2), leukotrienes (series 4), thromboxanes

## Omega-3 Pathway (Anti-inflammatory)

```
ALA (18:3 n-3) ──Δ6D──> SDA (18:4 n-3) ──E──> EPA (20:5 n-3) ──E──> DPA (22:5 n-3) ──E──> DHA (22:6 n-3)
 (Alpha-linolenic)    (Stearidonic)         (Eicosapentaenoic)   (Docosapentaenoic)  (Docosahexaenoic)
```

**EPA produces:** Prostaglandins (series 3), anti-inflammatory resolvins
**DHA produces:** Neuroprotectins, docosanoids

## Desaturase Enzymes (Rate-Limiting)
...
- **Same enzymes** process both n-3 and n-6
- **Excess n-6** saturates enzymes → reduced n-3 conversion
- **Direct EPA/DHA intake** bypasses inefficient conversion (<5% conversion rate)

## Clinical Fatty Acid Categories

| Type | Examples | Primary Role |
|------|----------|--------------|
| **Saturated** | Palmitic (16:0), Stearic (18:0) | Structure, energy |
| **MUFA** | Oleic (18:1), Palmitoleic (16:1) | Membrane fluidity |
| **PUFA n-6** | LA, GLA, AA | Pro-signaling |
| **PUFA n-3** | ALA, EPA, DHA | Anti-signaling |
