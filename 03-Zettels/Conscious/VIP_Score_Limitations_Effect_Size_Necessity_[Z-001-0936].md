...
- [[Effect_Size_Practical_Significance_Omics_[Z-001-0561].md]] — Effect size interpretation
- [[Biomarker_Validation_Requirements_[Z-001-0528].md]] — Validation standards
