...
**Core IR Panel:**
- [[Z-001-0047]] — HOMA-β (β-cell function companion)
- [[Z-001-0048]] — TyG Index (alternative IR marker)
- [[Z-001-0049]] — TG/HDL ratio (lipid-based IR proxy)

**Metabolic Context:**
- [[Z-001-0050]] — Metabolic syndrome criteria (3 of 5)
- [[Z-001-0043]] — HOMA-IR limitations and critique

**Cofactor Dependencies:**
- [[Z-002-0004]] — Vitamin D optimal range (D improves insulin sensitivity)
- [[Z-004-0001]] — Homocysteine (methylation supports insulin signaling)
