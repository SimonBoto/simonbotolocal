...
**Insulin Resistance:**
- [[Z-001-0046]] — HOMA-IR (Pattern B strongly associated with IR)
- [[Z-001-0049]] — TG/HDL ratio (Pattern B predictor)
- [[Z-001-0048]] — TyG Index (elevated in Pattern B)

**Lipid Components:**
- [[Z-006-0002]] — ApoB (Pattern B has more particles per mg/dL)
- [[Z-006-0003]] — Small dense LDL (sdLDL)

**Mechanism:**
- [[Z-001-0018]] — Lipotoxicity (IR → hepatic overproduction of VLDL → Pattern B)
