...
uid: Z-002-0611
type: zettel
title: "CIOMS International Research Ethics Guidelines"
aliases: [Z-002-0611, cioms-guidelines, international-research-ethics]
domain: 002
...
| Guideline | Focus |
|-----------|-------|
| 1 | Research must respond to health needs of host country |
| 2 | Research must be conducted in scientifically appropriate manner |
| 3 | Research must be approved by independent ethics committee |
| 4 | Informed consent required |
| 5 | Vulnerable groups require special protection |
...
- Access to intervention if proven beneficial
- Duration of access
...
| Issue | CIOMS Position |
|-------|----------------|
| Standard of care | Host country standard acceptable if scientifically justified |
| Placebo use | Permitted when no proven intervention exists |
