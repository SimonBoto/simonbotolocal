...
|------|---------|--------------|
| **RNA catalysts** | Ribosomal RNA | Pre-protein catalyst |
| **Fe-S clusters** | Aconitase, Complex I | Pre-organic cofactors |
| **Simple folds** | Triose phosphate isomerase | Ancient TIM barrel |
| **Vestigial reactions** | Reversible glycolysis | Before regulation needed |

### RNA World Evidence
| Feature | Modern Example |
|---------|---------------|
| **Ribosomes** | rRNA catalyzes peptide bonds (peptidyl transferase) |
...
| **DNA repair** | Endonucleases use Fe-S |

### Gene Fusion Events
| Fusion | Result |
|--------|--------|
| **Bifunctional enzymes** | Two reactions, one protein |
| **Protein complexes** | Separate genes → regulated assembly |

## Clinical Implication
- **Evolutionary medicine:** Understanding origins informs disease
- **Fe-S cluster disorders:** Mitochondrial dysfunction
- **Ribosomopathies:** Defects in ancient machinery
- **METHAP relevance:** Core metabolic pathways are ancient and highly conserved — supporting them honors billions of years of optimization

---

## Related
- [[RNA_World_Hypothesis_Evolution_Z-101-0456]] — RNA world
- [[Evolutionary_Ancient_Glycolysis_Z-001-0470]] — Ancient glycolysis
