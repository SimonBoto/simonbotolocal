...
|---------|-----------|----------|
| **Cholesterol** | 6 (modified) | Membranes, hormones, vitamin D |
| **CoQ10** | 10 | Mitochondrial electron transport |
...
- [[HMG_CoA_Reductase_Regulation_[Z-001-0567]]] — Regulatory mechanisms
- [[Mevalonate_Pathway_Energy_Cost_[Z-001-0568]]] — Energy requirements
- [[Isoprenoids_Terpenes_Overview_[Z-001-0569]]] — IPP products
- [[CoQ10_Dolichol_Isoprenoid_Synthesis_[Z-001-0571]]] — CoQ10 from IPP
