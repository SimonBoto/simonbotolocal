...
**Mechanism cascade:**
1. Complex I inhibition → ↓ ATP/AMP ratio
2. AMPK activation → ↑ fatty acid oxidation, ↓ lipogenesis
3. mTORC1 inhibition → ↓ c-myc, ↓ Hif-1α (growth factors)
4. Immunological: ↓ T-cell proliferation, ↑ B-cell function
5. Anti-inflammatory: ↓ ROS, ↓ IL-1β in macrophages
...
| Target | Effect |
|--------|--------|
| Mitochondrial Complex I | Inhibited (primary target) |
| AMPK | Activated |
| mTORC1 | Inhibited |
| T-cells | Proliferation reduced |
