...
**Function:**
- Encodes L-gulonolactone oxidase enzyme
- Catalyzes final step of vitamin C synthesis
- Converts glucose → vitamin C (ascorbate)

**Status in humans:**
- **Pseudogene** — non-functional remnant
...
|---------|--------|------------------|
| Humans | GULO pseudogene | Dietary intake required |
...
**Theory:**
- Ancestors consumed abundant fruit
- Endogenous synthesis became metabolically wasteful
- Mutations in GULO not selected against
- Eventually fixed in population

**Timing:**
- Loss occurred ~61 million years ago
...
---
*Z-001-0621 | Created: 2026-04-04 | Domain: 001*
