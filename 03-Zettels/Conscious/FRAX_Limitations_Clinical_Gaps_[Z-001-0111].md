...
## Related Zettels
- [[FRAX_Input_Variables_Clinical_Risk_Factors_[Z-001-0109].md]] — What's included
- [[FRAX_Adjustments_TBS_Falls_Glucocorticoids_[Z-001-0112].md]] — How to correct
- [[FRAX_Output_Thresholds_Treatment_Decisions_[Z-001-0110].md]] — When to override
