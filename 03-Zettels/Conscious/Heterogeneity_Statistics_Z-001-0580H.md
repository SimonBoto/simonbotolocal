...
- **I² statistic:** Percentage of total variation across studies due to heterogeneity (0-25%: low; 25-50%: moderate; 50-75%: substantial; >75%: considerable)
...
1. **Investigation:** Subgroup analysis, meta-regression, sensitivity analysis
2. **Model selection:** Random-effects model when heterogeneity is present
3. **Reporting:** Comprehensive documentation of heterogeneity statistics and interpretation
