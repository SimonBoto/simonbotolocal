...
**Dietary Folate** (polyglutamate) → **Dihydrofolate (DHF)** → **Tetrahydrofolate (THF)**

**Key Interconversions:**
```
THF ↔ 5,10-Methylene-THF ↔ 5-Methyl-THF
                ↓
        10-Formyl-THF
```

**Functions by Form:**
| Folate Form | One-Carbon | Role |
|-------------|------------|------|
| 5-MTHF | Methyl | Homocysteine → Methionine |
