...
- Carbohydrate reduction (specific % not detailed in source)
- Emphasis on whole foods, healthy fats, adequate protein
- Supported by systematic reviews and meta-analyses

### 2. Targeted Supplements

| Supplement | Brand | Form | EOF Notification |
|------------|-------|------|------------------|
...
| 3 | Pure D3 | Cholecalciferol | 111920/22-12-2014 |
...
|----------|-----------|----------|
| **Vitamin D** | Glucose , insulin sensitivity | Nazarian et al 2011, Aliashrafi et al 2020 |
...
IR participants not receiving intervention:
...
**Related:** [[METHAP_Study_Design_Overview_[Z-002-0616].md]] — Full study structure
