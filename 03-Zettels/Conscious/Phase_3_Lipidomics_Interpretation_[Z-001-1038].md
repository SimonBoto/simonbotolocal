...
### Fatty Acid Classes
| Class | Behavior | Clinical Relevance |
|-------|----------|-------------------|
| **SFA** | Structural, stable | Membrane rigidity |
| **MUFA** | Flexible, protective | Fluidity modulation |
| **PUFA** | Signaling, vulnerable | Oxidative risk vs. benefit |

### Critical Ratios (The "Ratio Gospel")
...
- **Membrane repair philosophy** — Why repairing membranes repairs systems
- **Seed oil collapse** — Oxidative PUFA fragmentation as clinical insult
- **Cholesterol as substrate of life** — Not just risk factor
...
### Case-Based Learning
- Link fatty acids to mitochondrial markers
- Connect lipid patterns to OAT organic acids
- Build multi-modal clinical narratives
