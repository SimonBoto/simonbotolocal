...
## Overview
Map of content for Research concepts, mechanisms, and clinical applications.
...
Statistical methodology, study design, and clinical research standards for metabolomics and biomarker research. Critical for PhD work and METHAP trial design.
...
- **Analysis plan:** Pre-specified, FDR-corrected
- **Validation:** External cohort planned
- **Reporting:** CONSORT + STROBE standards

### Statistical Considerations
- Multiple metabolite testing (3,000+)
- Paired design (baseline vs intervention)
- Effect size estimation from pilot data
- Dropout buffer (15-20%)
...
---
uid: MOC-20260404-006
type: "moc"
title: "MOC — Research Methodology"
aliases: ["MOC-Research-Methodology", "Research-Methodology-MOC"]
domain: "system"
description: "Experimental design, methods, and scientific approaches across disciplines"
tags: ["moc", "methodology", "research", "methods", "active"]
parent-moc: "[[MOCs-Index]]"
status: "active"
created: "2026-04-04"
...
# MOC: Research Methodology

> Experimental design, methods, and scientific approaches across disciplines
...
**Core Concepts:**
- [[Plant_Crossing_Metabolic_Discovery_Z-001-0615F]] — Large-scale forward genetics
...
### Forward Genetics
- `Plant_Crossing_Metabolic_Discovery_Z-001-0615F` — 643 lines, crossing, backcrossing

### Omics Methods
- Single-cell RNA-seq (from nicotine paper)
- Mass spectrometry (630 spectra)
- Isotope tracing
...
| MOC | Connection |
|-----|------------|
| `[[MOC-Research]]` | Specific techniques |
| `[[MOC-Genetic-Variation]]` | Mutation discovery |
| `[[MOC-Metabolic-Pathways]]` | Pathway elucidation |
...
| Date | Status | Notes |
|------|--------|-------|
| 2026-04-04 | created | Initial MOC |
...
## Overview
Map of content for Methodology concepts, mechanisms, and clinical applications.
