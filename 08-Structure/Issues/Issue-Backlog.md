...
1. Copy `TEMPLATE.md`
2. Fill in metadata
3. Save as `ISSUE-XXX.md` (next available number)
4. Add to this table
5. Move to `01-ACTIVE.md` when assigned

---

_See also: [01-ACTIVE.md](./01-ACTIVE.md) | [02-COMPLETED.md](./02-COMPLETED.md) | [TEMPLATE.md](./TEMPLATE.md)_
