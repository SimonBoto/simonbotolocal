...
| Biomarker | Information | Advantage |
|-----------|-------------|-----------|
| **Urine OA** | Mitochondrial function, nutrients, gut | Early detection, comprehensive |
| **Plasma TFA** | Membrane composition, inflammation | Functional status, diet reflection |
| **HOMA-IR** | Insulin resistance calculation | Standardized, validated |
| **HbA1c** | 3-month glucose average | Established clinical utility |

## Primary Outcome
Shift in metabolic biomarker profile from insulin-resistant pattern toward metabolically healthy pattern following intervention.
