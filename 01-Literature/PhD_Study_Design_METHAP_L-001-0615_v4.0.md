...
| **Metabolically healthy** | 60 (observational) |
| **Insulin-resistant** | 160 (intervention study) |
| **Intervention group** | 80 (diet + supplements) |
| **Control group** | 80 (no intervention) |

## Primary Outcome
Shift in metabolic biomarkers (urine OA, plasma TFA) from insulin-resistant pattern toward metabolically healthy pattern.
