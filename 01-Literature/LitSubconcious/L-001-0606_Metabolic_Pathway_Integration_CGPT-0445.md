...
Glucose          Fatty Acids         Amino Acids
     |                  |                  |
     v                  v                  v
Glycolysis       Beta-oxidation     Deamination
     |                  |                  |
     +----------+-------+----------+-------+
                |                  |
                v                  v
...
## Connections
- **METHAP relevance:** Metabolism is an integrated network—METHAP supports multiple pathways simultaneously (glycolysis via B1, PPP via B1/B2/B3, Krebs via B-vitamins and mitochondrial nutrients).

## Zettels Created from This Source
1. [[Glycolysis_PPP_Integration_Bidirectional_Flow_Z-001-1110]] — Glycolysis-PPP link
2. [[Pyruvate_Metabolic_Hub_Multiple_Fates_Z-001-1111]] — Pyruvate hub
3. [[Acetyl_CoA_Central_Metabolic_Connector_Z-001-1112]] — Acetyl-CoA connector
4. [[Metabolic_Flexibility_Fuel_Switching_Capacity_Z-001-1113]] — Metabolic flexibility
