...
- **ChatGPT conversations:** 
  - [[CGPT_0281_Seed_Oils_and_Metabolic_Health_CGPT-0281]]
...
- **LTB4 (Leukotriene B4):** Neutrophil chemotaxis, adhesion
...
2. **IKKβ/NF-κB** → Inflammatory cytokines → Insulin resistance
...
These mechanisms operate synergistically:
```
High omega-6 intake
    ↓
Pro-inflammatory eicosanoids + Oxidized LDL + Endotoxin
    ↓
Chronic inflammation + Oxidative stress
    ↓
JNK/IKKβ activation + Mitochondrial dysfunction
    ↓
