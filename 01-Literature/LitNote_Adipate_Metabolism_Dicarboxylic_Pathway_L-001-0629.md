...
```
Glutaryl-CoA (C5) + FAD → Glutaconyl-CoA + FADH₂
          ↓
Glutaconyl-CoA + H₂O → L-3-Hydroxyglutaryl-CoA
          ↓
...
- Succinyl-CoA (C4) → **Direct Krebs cycle intermediate**
- Acetyl-CoA (C2) → enters Krebs cycle or ketogenesis
- 1 FADH₂ → ETC
- 1 NADH → ETC

#### Step 4: Entry into Krebs Cycle
```
Succinyl-CoA + GDP + Pi → Succinate + GTP + CoA
```
- Succinyl-CoA is a direct intermediate in the Krebs cycle
- Position: Between α-ketoglutarate and succinate
- Fate: Continues through remaining Krebs cycle steps to produce:
  - More NADH and FADH₂
  - Additional ATP (via GTP)
...
**Complete Oxidation of One Adipate Molecule:**

| Stage | ATP Yield | Source |
|-------|-----------|--------|
| **2 rounds β-oxidation** | 5 ATP | 2 NADH + 2 FADH₂ |
| **2 acetyl-CoA** | 20 ATP | Each yields ~10 ATP via Krebs |
| **Succinyl-CoA → Krebs** | 4 ATP | GTP equivalent + subsequent steps |
| **Total** | **~29 ATP** | |

**Comparison:** Glucose (6C) yields ~30-32 ATP
**Conclusion:** Adipate is a significant energy source when fully metabolized

---

### 5. Clinical Implications

#### Elevated Urinary Adipate = Metabolic Bottleneck

**When Adipate Accumulates:**
- ω-oxidation production exceeds dicarboxylic acid pathway capacity
- Liver/kidney mitochondria overwhelmed
- Energy extraction incomplete
- Marker of metabolic dysfunction

#### In Insulin Resistance
**Interpretation:**
- Early IR: Mild adipate elevation (compensation still functioning)
- Advanced IR: Significant adipate elevation (pathway saturated)
- Progression marker: Rising adipate predicts worsening IR

---

### 6. Comparison: Normal vs. Impaired Metabolism

| Condition | Adipate Production | Adipate Metabolism | Urinary Excretion |
|-----------|-------------------|-------------------|-------------------|
| **Normal** | Minimal | Efficient | Low (< 20 mg/g) |
| **Early IR** | Increased | Partially compensated | Mild elevation |
| **Advanced IR** | High | Overwhelmed | Significantly elevated |
| **MCAD Deficiency** | Massive | Attempted but insufficient | Very high |
...
- Enzymes characterized in liver and kidney mitochondria
- P450 ω-oxidation and subsequent β-oxidation of dicarboxylic acids

### Clinical Metabolism
- Urinary dicarboxylic acid patterns in metabolic disorders
- Energy contribution from ω-oxidation products
