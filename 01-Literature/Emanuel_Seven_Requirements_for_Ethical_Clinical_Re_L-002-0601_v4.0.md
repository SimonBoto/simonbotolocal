...
## Source
- **Full citation:** Emanuel EJ, Wendler D, Grady C. What makes clinical research ethical? JAMA. 2000;283(20):2701-2711.
- **PMID:** 10819955
- **DOI:** 10.1001/jama.283.20.2701
- **Link:** ChatGPT Archive CGPT-0131

## Core Concepts Extracted

### 1. Social and Clinical Value (Essentiality)
> "Research must enhance health or increase knowledge significantly. It should answer important questions that justify the risks involved."
...
**Critical principle:** Informed consent alone is neither necessary nor sufficient for ethical research. All seven requirements must be satisfied.

This framework applies universally, though adaptations may be needed for local health, economic, cultural, and technological conditions.

## My Notes

**Synthesis:** This is the foundational ethics framework for clinical research. The seven requirements provide a comprehensive checklist for IRB preparation and ongoing trial conduct. For METHAP, each requirement must be explicitly addressed in the protocol.

**Connection to METHAP/PhD:**
- **Value:** Adipic acid as IR biomarker has clear clinical value
- **Validity:** Metabolomics methodology is scientifically sound
- **Fair Selection:** Inclusion/exclusion criteria must be justified
- **Risk-Benefit:** Blood draws minimal risk vs. knowledge gain
- **Independent Review:** NKUA ethics committee approval required
- **Informed Consent:** Detailed consent form required
- **Respect:** Ongoing monitoring, data protection, withdrawal rights

**Questions:**
- How does Greek ethics committee specifically apply these seven requirements?
- Are there additional national requirements beyond these seven?
