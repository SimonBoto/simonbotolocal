...
```
Insulin → Insulin Receptor → IRS-1/2 → PI3K → Akt → mTORC1
                                            ↓
...
**Sirolimus Effect:**
- Direct inhibition of mTORC1 disrupts downstream signaling
- Impaired GLUT4 vesicle trafficking to cell membrane
- Reduced glucose uptake in peripheral tissues
- **Peripheral insulin resistance**

**Tissues Affected:**
- Skeletal muscle (major site of glucose disposal)
- Adipose tissue
- Cardiac muscle
...
**Reduced β-Cell Mass:**
- Chronic sirolimus associated with β-cell loss
- Mechanism: apoptosis from metabolic stress + autophagy dysregulation
...
- Less sensitive to acute rapamycin than mTORC1
- Inhibited by chronic/high-dose sirolimus

**mTORC2 → Akt Pathway:**
- mTORC2 phosphorylates Akt at Ser473 (activation site)
- Akt = central mediator of insulin signaling
- Akt activation required for:
  - GLUT4 translocation
  - Glycogen synthesis
  - Lipogenesis suppression

**Sirolimus Effect:**
- Chronic/high-dose → mTORC2 inhibition
...
Sirolimus → Impaired adipogenesis + Increased lipolysis
    ...
    ┌───────────────┼───────────────┐
    ↓               ↓               ↓
Muscle IR      Liver IR        β-cell damage
(GLUT4         (gluconeogenesis  (glucolipotoxicity)
