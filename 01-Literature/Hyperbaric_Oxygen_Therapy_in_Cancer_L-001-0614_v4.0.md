...
|-----------|-----------------|
| **Pressure** | 1.5-3.0 ATA (atmosphere absolute) |
| **Oxygen concentration** | 100% |
| **Session duration** | 60-90 minutes |
| **Number of sessions** | 20-40 for most indications |

## Synergy with Metabolic Therapy

| Combination | Rationale |
|-------------|-----------|
| **HBOT + Ketogenic diet** | Oxidative stress + metabolic stress |
| **HBOT + Vitamin C** | Enhanced ROS generation |
| **HBOT + Radiation** | Overcome hypoxia resistance |
