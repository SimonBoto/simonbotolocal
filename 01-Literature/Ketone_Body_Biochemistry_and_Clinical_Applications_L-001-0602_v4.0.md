...
**Zettel:** [[Three_Ketone_Bodies_Acetoacetate_BHB_Acetone_Z-001-1093]]

### 2. Ketogenesis Mechanism
> "Ketogenesis occurs in liver mitochondria when acetyl-CoA accumulates beyond TCA cycle capacity."

**Zettel:** [[Ketogenesis_Mechanism_Liver_Mitochondria_Z-001-1094]]
...
**Zettel:** [[BHB_Hydroxyacid_Not_True_Ketone_Z-001-1095]]

### 4. Therapeutic Ketosis
> "Ketogenic diets used for epilepsy, neurodegenerative diseases, metabolic disorders."

**Zettel:** [[Therapeutic_Ketosis_Clinical_Applications_Z-001-1096]]

## The Ketone Body Hierarchy

```
Fatty acids → Acetyl-CoA → Acetoacetate (primary ketone)
                    ↓
            BHB (reduced form, major circulating)
                    ↓
            Acetone (spontaneous decarboxylation)
```

## Clinical States of Ketogenesis

| State | Trigger | Ketone Level | Purpose |
|-------|---------|--------------|---------|
| **Fasting** | No glucose intake | Moderate | Brain fuel preservation |
| **Ketogenic diet** | Low carbohydrate | Moderate-High | Therapeutic, weight loss |
| **Prolonged exercise** | Glycogen depletion | Moderate | Muscle fuel alternative |
