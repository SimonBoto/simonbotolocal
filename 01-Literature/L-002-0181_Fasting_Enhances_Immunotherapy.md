...
# Lit: Fasting Enhances Immunotherapy Effectiveness

## Source
- **Full citation:** (Pending — Cell Metabolism 2026)
- **Inbox origin:** [[Νηστεία-Ανοσοθεραπεία-Καρκίνος]]
...
- **Reference:** (Pending — Cell Metab 2026) — cited as (Author et al., 2026)
...
|-----------|---------|-------------|
| Cell Metab 2026 (pending) | Zettel 1, Zettel 2, Zettel 3 | 3 |
...
|-----------|---------------|----------|--------|
| Longo et al. FMD studies | Foundation work | P0 | pending |
| Fasting + chemotherapy trials | Combination data | P1 | pending |
| Tumor metabolism immunology | Mechanism depth | P1 | pending |

---

## Structural Links
- **Up:** [[MOC-Cancer-Metabolism]] — Thematic domain
- **Inbox:** [[Νηστεία-Ανοσοθεραπεία-Καρκίνος]] — Raw origin
