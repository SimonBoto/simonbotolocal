...
| Stage | Focus | Goal |
|-------|-------|------|
| 1. Assessment | Intake ritual | Understand patient as metabolic story |
| 2. Sample Logistics | Pre-analytical discipline | Ensure diagnostic accuracy |
| 3. Analysis | OAT + fatty acid interpretation | Create coherent metabolic narrative |
| 4. Reporting | Metabolic storytelling | Explain findings in human language |
| 5. Treatment | Therapeutic algorithm | Mechanism-based prescribing |
| 6. Follow-up | Longitudinal care | Evaluate trends and compliance |

## My Notes

**Synthesis:** This framework operationalizes metabolomics training beyond content delivery—it creates a reproducible system for training clinicians in both knowledge and reasoning.

**Connection to METHAP/PhD:** The Socratic method and tiered architecture could inform research assistant training and protocol standardization.

**Questions:**
- How does this scale to multiple trainees simultaneously?
