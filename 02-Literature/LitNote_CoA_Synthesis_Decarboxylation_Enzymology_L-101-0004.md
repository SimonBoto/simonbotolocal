...
|--------|-----------|---------|----------|---------|
| **Pyruvate dehydrogenase** | Pyruvate | Acetyl-CoA | TPP, lipoate, CoA, FAD, NAD⁺ | Glycolysis/TCA |
| **α-ketoglutarate dehydrogenase** | α-ketoglutarate | Succinyl-CoA | TPP, lipoate, CoA, FAD, NAD⁺ | TCA cycle |
| **Isocitrate dehydrogenase** | Isocitrate | α-ketoglutarate | NAD⁺/NADP⁺, Mn²⁺/Mg²⁺ | TCA cycle |
| **Pyruvate decarboxylase** | Pyruvate | Acetaldehyde | TPP | Fermentation (yeast) |
| **Glutamate decarboxylase** | Glutamate | GABA | PLP | Neurotransmitter synthesis |
| **Histidine decarboxylase** | Histidine | Histamine | PLP | Immune/allergic response |
...
|---------|---------------|----------------|
| **Primary reaction** | Oxidation (H⁺ removal) | Decarboxylation (CO₂ removal) |
| **Redox involved?** | Yes | Usually no |
