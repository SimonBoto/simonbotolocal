...
| Target | Strategy |
|--------|----------|
| **Hexokinase II** | Inhibit first step of glycolysis |
| **LDH-A** | Block lactate production |
| **MCT transporters** | Prevent lactate export |
| **Pyruvate kinase M2** | Target cancer-specific isoform |
