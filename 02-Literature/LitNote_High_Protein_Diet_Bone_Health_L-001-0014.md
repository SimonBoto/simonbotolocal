...
## Key Figures & Data
- **Standard protein:** 1.0–1.2 g/kg/day
- **High-risk protein:** Up to 1.5 g/kg/day
- **Target population:** Sarcopenia, frailty, high fracture risk
- **Sources:** Lean meats, dairy, eggs, legumes

---

## My Notes

**Synthesis:** The muscle-bone unit concept reframes osteoporosis from purely bone-centric to musculoskeletal. Protein is substrate for both bone matrix and muscle—loss of either compromises the other. This is synergistic with D+K2 (calcium handling).

**Connection to METHAP/PhD:** Protein metabolism markers could be part of comprehensive metabolic assessment.

**Questions:**
- Does BUN/creatinine ratio correlate with bone turnover?
- Can amino acid profiling predict fracture risk?
