...
## Citation
Jonker R, Engelen MP, Deutz NE. Role of specific dietary amino acids in clinical conditions. Br J Nutr. 2012 Aug;108 Suppl 2:S139-48.

## Source Context
**Cited in:** NKUA DE4, Section 2.1 (protein metabolism)  
**Context:** Amino acid metabolism in disease

## Relevance to METHAP Trial

### Content Areas
- Specific amino acid metabolic roles
- Clinical condition associations
- Dietary modification implications

### METHAP Applications
- Branched-chain amino acids (BCAA) in IR
- Glutamine-glutamate metabolism
- Urea cycle function

## Research Tasks
- [ ] Identify BCAA-IR mechanisms
- [ ] Assess amino acid panel value for IR
...
*Priority: MEDIUM — Amino acid background*